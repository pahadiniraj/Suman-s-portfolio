export const buttonPrimary =
  "bg-primary text-black py-2 px-5 rounded-full hover:bg-custom-dark hover:ring-1 hover:ring-primary border border-primary cursor-pointer";
...
export const headingPrimary = "text-primary text-3xl font-medium";

export const titlePrimary = "text-primary text-2xl font-bold";

export const titleSecondary = "text-custom-light-high text-2xl font-bold";

export const boxShadowPrimary = "shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px]";
...
export const formStyle =
  "bg-custom-light-low bg-opacity-20 rounded-lg p-5 flex flex-col gap-2";
...
export const editButtonStyle =
  "bg-custom-green py-1 w-full rounded hover:bg-opacity-50 text-white";

export const deleteButtonStyle =
  "bg-custom-crimson py-1 w-full rounded hover:bg-opacity-50 text-white";
